...
The project demonstrates **real-world data engineering practices**, including handling incomplete web data using logical computation and clearly documented assumptions.
...
- **Stations in between** – derived from ordered station list  
